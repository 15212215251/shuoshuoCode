...
public class SocketClient {
	...
	public String sendMessage(String strMessage) {
		...
		try {
			...
			//从redis获取变量
//			String connect2190  = RedisUtil.getRedis("connect","2190");
//			if(connect2190 == null || "".equals(connect2190.trim())){
//				connect2190 = "0";
//			}
//			if(Integer.parseInt(connect2190) >= 5){
//				log.error("---->超时信息太多限制");
//				str = "2199";
//				return str;
//			}
			...
			//获取最新的连接数
//			if("2190".equals(str)){
//				boolean connect2190cnt  = RedisUtil.setRedisNx("connect2190");
//				System.out.println("connect2190cnt=="+connect2190cnt);
//			}
